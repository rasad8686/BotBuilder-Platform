      ...
      <div className="min-h-screen bg-gray-50 dark:bg-slate-900 p-4 sm:p-8 transition-colors duration-300">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <div className="h-10 bg-gray-200 dark:bg-slate-700 rounded w-64 mx-auto mb-4 animate-pulse" />
            <div className="h-4 bg-gray-200 dark:bg-slate-700 rounded w-96 mx-auto animate-pulse" />
          </div>
          <div className="mb-8">
            <SkeletonCard />
          </div>
