...
export const SkeletonCard = ({ className = '' }) => (
  <div className={`p-4 border border-gray-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-800 ${className}`}>
    <div className="h-6 bg-gray-200 dark:bg-slate-700 rounded animate-pulse w-3/4 mb-4" />
    <div className="h-4 bg-gray-200 dark:bg-slate-700 rounded animate-pulse w-full mb-2" />
...
export const SkeletonTable = ({ rows = 5, cols = 4, className = '' }) => (
  <div className={`border border-gray-200 dark:border-slate-700 rounded-lg overflow-hidden ${className}`}>
    {/* Header */}
    <div className="flex bg-gray-100 dark:bg-slate-800 p-3 gap-4">
    ...
    {Array(rows).fill(0).map((_, rowIndex) => (
      <div key={rowIndex} className="flex p-3 gap-4 border-t border-gray-200 dark:border-slate-700">
