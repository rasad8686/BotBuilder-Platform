...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.BotBuilderTours = {}));
  ...
  /**
   * Fetch eligible tours based on server-side targeting
   * @param {Object} context - Targeting context
   * @returns {Promise<Array>}
   */
  async function fetchEligibleTours(context = {}) {
    const params = new URLSearchParams({
      url: context.currentUrl || window.location.href
    });
    if (context.userProperties) {
      params.append('properties', JSON.stringify(context.userProperties));
    }
    const response = await request(`/api/public/tours/eligible?${params.toString()}`);
    return response.tours || [];
  }

  /**
   * Evaluate targeting for a specific tour
   * @param {string} tourId - Tour ID
   * @param {Object} context - Targeting context
   * @returns {Promise<Object>}
   */
  async function evaluateTourTargeting(tourId, context = {}) {
    return request(`/api/public/tours/${tourId}/evaluate`, {
      method: 'POST',
      body: JSON.stringify({
        url: context.currentUrl || window.location.href,
  ...
  /**
   * Collect targeting context from browser
   * @returns {Object}
   */
  function collectTargetingContext() {
    return {
  ...
  exports.TourRenderer = TourRenderer;
  exports.TourSDK = TourSDK;
  exports.adjustForViewport = adjustForViewport;
  exports.batchTrackEvents = batchTrackEvents;
  exports.calculateArrowOffset = calculateArrowOffset;
  exports.calculateModalPosition = calculateModalPosition;
  exports.calculatePosition = calculatePosition;
  exports.calculateSlideoutPosition = calculateSlideoutPosition;
  ...
  exports.dismissTourForSession = dismissTourForSession;
  exports.endTour = endTour;
  exports.fetchActiveTours = fetchActiveTours;
  ...
  exports.getCenteredPosition = getCenteredPosition;
  ...
  exports.hasTourBeenSeen = hasTourBeenSeen;
  ...
  exports.isTourCompleted = isTourCompleted;
  exports.isTourDismissedForSession = isTourDismissedForSession;
  exports.isTourSkipped = isTourSkipped;
  exports.markTourAsSeen = markTourAsSeen;
  exports.nextStep = nextStep;
  exports.onComplete = onComplete;
  exports.onSkip = onSkip;
  exports.onStart = onStart;
  exports.onStepComplete = onStepComplete;
  exports.onStepViewed = onStepViewed;
...
//# sourceMappingURL=tours-sdk.js.map
