/**
 * Blog/Tutorials System Migration
 * Tables: blog_posts, blog_comments, tutorials, tutorial_steps, tutorial_progress
 */
...
exports.up = function(knex) {
  return knex.schema
    ...
    .createTable('blog_comments', table => {
      ...
      table.integer('parent_comment_id').unsigned().references('id').inTable('blog_comments');
      table.text('content').notNullable();
    ...
    .createTable('tutorial_progress', table => {
      table.increments('id').primary();
      table.integer('tutorial_id').unsigned().references('id').inTable('tutorials');
      table.integer('user_id').unsigned().references('id').inTable('users');
